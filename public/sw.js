const CACHE_NAME = 'betta47-v1';
const STATIC_CACHE = 'betta47-static-v1';
const DYNAMIC_CACHE = 'betta47-dynamic-v1';

// Risorse da cachare immediatamente - personalizzato per Betta47
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/vite.svg',
